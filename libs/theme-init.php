...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'homepage-thumb', 360, 240, false); // (ritagliata)
...
/* Add stylesheets and custom js to my theme */
	...
	function theme_setup() {
		...
		wp_enqueue_script( 'my-ajax-request', get_template_directory_uri() . '/assets/js/ajax.js', array( 'jquery' ) );
		...
		//all JS
		wp_enqueue_script( 'jquery', get_template_directory_uri() . '/assets/js/jquery-1.10.2.js', array(), '1.10.2', true );
